...
<div className='flex gap-5 bg-gray-200 mx-5 rounded-lg px-3 py-2 mt-5 text-[1.2rem]'>
    ...
    <div className='px-16 py-0 text-gray-600 hover:text-black hover:bg-white cursor-pointer border-r border-gray-400 rounded hover:shadow-md shadow-black'
    ...
    <div className='px-16 py-0 text-gray-600 hover:text-black hover:bg-white cursor-pointer  rounded hover:shadow-md shadow-black'
